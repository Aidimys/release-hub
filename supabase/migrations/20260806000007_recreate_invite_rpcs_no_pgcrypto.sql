...
-- =============================================================================
-- 7. Re-create invite RPC functions using built-in PostgreSQL functions
--    instead of pgcrypto's gen_random_bytes / digest.
--
--    The original migration (000005) used gen_random_bytes() and digest()
--    from the pgcrypto extension, which may not be enabled. These built-in
--    alternatives are always available:
--      - gen_random_uuid()  (PostgreSQL 13+ built-in, already used for id defaults)
--      - md5()              (PostgreSQL built-in hash)
-- =============================================================================
...
REVOKE EXECUTE ON FUNCTION public.create_invite(uuid, text, public.workspace_role) FROM PUBLIC;
